...
class RegleNoteApp {
    ...
    private async create(req: Request, res: R, next: NextFunction): Promise<void> {
        try {
            ...
            Response.error(res, "Erreur lors de la cr�ation de la r�gle de note", 400, error as Error);
        }
    }
    ...
    private async getAll(req: Request, res: R, next: NextFunction): Promise<void> {
        try {
            ...
            Response.error(res, "Erreur lors de la r�cup�ration des r�gles de notes", 400, error as Error);
        }
    }
